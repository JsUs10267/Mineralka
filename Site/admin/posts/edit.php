        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                ...
                <form action="edit.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        <input value="<?=$post['title'] ?>" name="title" type="text" class="form-control" placeholder="Полное название" aria-label="Название">
                    </div>
                    <div class="col">
                        <label for="content" class="form-label">Кол-во в упаковке и цена за 1 упаковку</label>
                        <input value="<?=$post['content'] ?>" name="content" type="text" class="form-control" placeholder="В упаковке - ...шт. ; Цена за 1 уп. - ..." aria-label="Название">
                    </div>
                    ...
                    <div class="col">
                        <button name="edit_post" class="btn btn-primary" type="submit">Сохранить изменения</button>
                    </div>
                </form>
            </div>
        </div>
